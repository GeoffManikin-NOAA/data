...
#RETRO_DIR="/gpfs/dell2/ptmp/$USER/com/ECMWF"
RETRO_DIR="/gpfs/dell1/ptmp/Geoffrey.Manikin/ecmwf"

REPO_DIR="/gpfs/dell2/emc/verification/save/Logan.Dawson/EMC_meg/GFSv16_physics_eval_scripts"
